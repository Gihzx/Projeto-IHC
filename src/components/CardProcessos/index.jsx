    ...
    return (
        <div className="container-card">
            <div className="header-card">
                <div className="logo-user-card">
                    {props.sigla_nome}
                </div>
                <div className="header-card-details">
                    <span>{props.nome}</span>
                    <span className='subinfo'>{props.curso}</span>
                    <span className='subinfo'>{props.matricula}</span>
                </div>
            ...
            <div className="body-card">
                <div className="body-card-details">
                    ...
                    <span>Data solicitação: {props.data_solicitacao}</span>
                    <span>Processo: {props.processo}</span>
                </div>
            </div>
            <div className="footer-card">
                <a href="#" className="btn-atender-solicitacao">Atender solicitação</a>
            </div>
        </div>
    )
}
